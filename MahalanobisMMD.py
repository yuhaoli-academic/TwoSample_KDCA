...
def run_MMMD_experiment(dgp_number, mm, nn, dd, loc, scale, df, dgp_set, Nrep):
    ...
    def process_iteration(ss):
        ...
        # 2. Run MMMD Test
        # Using default 'Gauss MMMD' configuration (5 kernels)
        p_val = MMMD_test(X, Y, n_bootstrap=500)
...
# %%
print("MMMD Test Simulation (Mahalanobis Aggregated MMD)")
