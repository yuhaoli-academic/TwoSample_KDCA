...
- **Root experiment scripts:** Shared helper functions are implemented in files such as `BMMD.py`, `LinearTimeMMD.py`, `MMDAgg_run_file.py`, `MMDAggInc_run_file.py`, `MMDFUSE.py`, `MahalanobisMMD.py`, `MartingaleMMD.py`, `SpectralReguMMD.py`, `spectrum_mmd_test.py`, `mmd_oracle.py`, `mmd_permu.py`, `xMMD.py`, `time_comparison.py`, `learning_mb.py`, `learn_multipicity_pivotal.py`, and `single_kernel_truncate_pivotal.py`.
- **Root experiment scripts:** Method-specific scripts in the root directory reproduce the main simulation results, including `functions.py`, `functions_bMMD.py`, `functions_MMDAgg.py`, `functions_MMDAggInc.py`, `functions_MMDFUSE.py`, `functions_MahalanobisMMD.py`, `functions_MartingaleMMD.py`, `functions_SpectralReguMMD.py`, `functions_LinearTimeMMD.py`, `functions_mmd.py`, `functions_mmd_oracle.py`, `functions_spectrum_mmd.py`, and `functions_xmmd.py`.
